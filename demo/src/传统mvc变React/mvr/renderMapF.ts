import { VirtaulDomNode, VirtualDomOperator, cloneMap, storeRef } from "better-react";
import { draftParentFiber, renderBaseFiber, revertParentFiber, useComputed, useParentFiber } from "./fc";
import { Fiber } from "./Fiber";
import { getEmptyArray } from "./util";
////////****useMap****////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
export function renderMapF<M, C>(
  ...
  return renderBaseFiber(dom, function () {
    const mapRef = useComputed(createMapRef, getEmptyArray)()
