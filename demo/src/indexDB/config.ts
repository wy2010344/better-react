...
export type DBConfig = {
  name: string
  upgradeneeded: ((idbReq: DBReq, e: IDBVersionChangeEvent) => void)[]
  onversionchange?: (idbReq: DBReq, e: IDBVersionChangeEvent) => void
...
export function getIndexedDB(config: DBConfig) {
