...
export default function () {
  dom.div({
    className: cns(clsMap.parent, "parent"),
    style: `
  width: 290px;
  height: 300px;
  perspective: 1000px;
  ...
  transform-style: preserve-3d;
        ...
        dom.span({
          className: cns(clsMap.circle, "circle circle1"),
          style: `  
        ...
        dom.span({
          className: cns(clsMap.circle, "circle circle2"),
          style: `  
          width: 140px;
          top: 10px;
          right: 10px;
        ...
        dom.span({
          className: cns(clsMap.circle, "circle circle3"),
          style: `  
          width: 110px;
          top: 17px;
          right: 17px;
        ...
        dom.span({
          className: cns(clsMap.circle, "circle circle4"),
          style: `
          width: 80px;
          top: 23px;
          right: 23px;
        ...
        dom.span({
          className: cns(clsMap.circle, "circle circle5"),
          style: `
          width: 50px;
          top: 30px;
          right: 30px;
  ...
  font-size: 20px;
          `
        }).renderTextContent("UIVERSE (3D UI)")
        dom.span({
          className: "text",
          style: `
  display: block;
  ...
  margin-top: 20px;
          `
        }).renderTextContent("Create, share, and use beautiful custom elements made with CSS")
      })
      dom.div({
        className: "bottom",
        style: `
  ...
  transform-style: preserve-3d;
          ...
          dom.button({
            className: cns(clsMap.socialButton, "social-button .social-button1")
          }).render(() => {
            svg.svg({
              viewBox: "0 0 30 30",
              xmlns: "http://www.w3.org/2000/svg",
          ...
          dom.button({
            className: cns(clsMap.socialButton, "social-button .social-button2")
          }).render(() => {
            svg.svg({
              viewBox: "0 0 512 512",
              xmlns: "http://www.w3.org/2000/svg",
          ...
          dom.button({
            className: cns(clsMap.socialButton, "social-button .social-button3")
          }).render(() => {
            svg.svg({
              viewBox: "0 0 640 512",
              xmlns: "http://www.w3.org/2000/svg",
        ...
        dom.div({
          className: cns(clsMap.viewMore, "view-more"),
          style: `
  display: flex;
  align-items: center;
  width: 40%;
